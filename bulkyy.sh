...
cat $target | katana -d 5 -ps -pss waybackarchive,commoncrawl,alienvault | anew -q waybackurls.txt
cat $target |  hakrawler -subs -d 8 -insecure | anew -q waybackurls.txt
